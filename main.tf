...
module "eks_cluster_and_worker_nodes" {
  ...
  eks_cluster_name = var.cluster_name
  eks_cluster_subnet_ids = flatten(["subnet-0688a7c8ee295a5e5","subnet-07f3018275fbf71e2"])
  ...
  private_subnet_ids = flatten(["subnet-0688a7c8ee295a5e5","subnet-07f3018275fbf71e2"])
}